...
public class Parser {
    public static List<com.example.lab6_lab5_rimantek.CurrencyRate> parse(InputStream input) throws Exception {
    ...
    private static class RatesHandler extends DefaultHandler {
        private final List<com.example.lab6_lab5_rimantek.CurrencyRate> items = new ArrayList<>();
            ...
            switch (qName) {
                ...
                case "item":
                    if (currentCode != null && currentRate != null) {
                        items.add(new com.example.lab6_lab5_rimantek.CurrencyRate(
                                currentCode,
